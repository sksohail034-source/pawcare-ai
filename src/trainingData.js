export const dogTraining = [
  { 
    ...
    videos: [
      ...
      { id: 'jFMA5ggFsXU', title: 'Video 2: Dog Training 101 Basics', dur: '12 min' },
      { id: 'kGbYT5zMRVk', title: 'Video 3: Puppy Survival Guide', dur: '15 min' },
    ]
  },
  { 
    month: 2, 
  ...
  { 
    ...
    videos: [
      { id: 'GzsVMnVbRbU', title: 'Video 1: Potty Training', dur: '12 min' },
      { id: 'V0U1vBksRDw', title: 'Video 2: Crate Training', dur: '9 min' },
