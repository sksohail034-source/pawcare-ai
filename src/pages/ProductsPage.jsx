...
export default function ProductsPage() {
  ...
  ,
  { id: 'boltz-bird-food', name: 'Boltz Bird Food for Budgies (1.2 kg)', brand: 'Boltz', category: 'food', subCategory: 'Bird Food', petType: 'bird', price: '299', rating: 4.3, reviews: 12500, image: '/images/products/boltz-bird-food.jpg', badge: 'Best Seller', desc: 'Premium seed mix tailored for Budgies to boost immunity and maintain healthy feathers.', benefits: ['100% Natural', 'High in vitamins', 'Easily digestible'], affiliateUrl: 'https://www.amazon.in/s?k=Boltz+Bird+Food+for+Budgies+1.2kg&tag=mypawcare-21' },
  { id: 'vitapol-bird-treat', name: 'Vitapol Smakers for Cockatiel (Fruit Flavor)', brand: 'Vitapol', category: 'toys', subCategory: 'Bird Treat', petType: 'bird', price: '399', rating: 4.5, reviews: 3200, image: 'https://images.unsplash.com/photo-1543852786-1cf6624b9987?w=400&q=80', badge: 'Amazon Choice', desc: 'Nutritious fruit treat sticks that encourage natural foraging behavior.', benefits: ['Rich in natural fruits', 'Wooden stick included', 'Promotes active foraging'], affiliateUrl: 'https://www.amazon.in/s?k=Vitapol+Smakers+for+Cockatiel&tag=mypawcare-21' },
  { id: 'bird-cage', name: 'Jainsons Pet Products Medium Bird Cage', brand: 'Jainsons', category: 'cages', subCategory: 'Bird Cage', petType: 'bird', price: '899', rating: 4.1, reviews: 1800, image: '/images/products/bird-cage.jpg', badge: 'Top Rated', desc: 'Spacious wire cage with feeding bowls and perches.', benefits: ['Anti-rust coating', 'Includes feeding bowls', 'Removable bottom tray'], affiliateUrl: 'https://www.amazon.in/s?k=Jainsons+Pet+Products+Medium+Bird+Cage&tag=mypawcare-21' },
  { id: 'vitapol-rabbit-food', name: 'Vitapol Economic Food for Rabbit (1.2 kg)', brand: 'Vitapol', category: 'food', subCategory: 'Rabbit Pellets', petType: 'rabbit', price: '450', rating: 4.4, reviews: 4100, image: '/images/products/vitapol-rabbit-food.jpg', badge: 'Best Seller', desc: 'A balanced everyday diet consisting of high-quality pellets.', benefits: ['High fiber content', 'Helps wear teeth down', 'Enriched with vitamins'], affiliateUrl: 'https://www.amazon.in/s?k=Vitapol+Economic+Food+for+Rabbit+1.2kg&tag=mypawcare-21' },
  { id: 'rabbit-hay', name: 'Boltz Premium Timothy Hay for Rabbits (400g)', brand: 'Boltz', category: 'food', subCategory: 'Rabbit Hay', petType: 'rabbit', price: '399', rating: 4.2, reviews: 2500, image: '/images/products/rabbit-hay.jpg', badge: 'Amazon Choice', desc: 'Sun-cured Timothy hay providing essential roughage.', benefits: ['100% natural hay', 'Prevents obesity', 'High fiber'], affiliateUrl: 'https://www.amazon.in/s?k=Boltz+Premium+Timothy+Hay+for+Rabbits&tag=mypawcare-21' },
  { id: 'taiyo-fish-food', name: 'Taiyo Pluss Discovery Special Fish Food (1 kg)', brand: 'Taiyo', category: 'food', subCategory: 'Fish Food', petType: 'fish', price: '350', rating: 4.2, reviews: 15800, image: '/images/products/taiyo-fish-food.jpg', badge: 'Best Seller', desc: 'Highly nutritious daily diet formulated with color-enhancing ingredients.', benefits: ['Does not cloud water', 'Spirulina added', 'Promotes rapid growth'], affiliateUrl: 'https://www.amazon.in/s?k=Taiyo+Pluss+Discovery+Special+Fish+Food+1kg&tag=mypawcare-21' },
  { id: 'sobo-filter', name: 'SOBO WP-1050F Internal Aquarium Filter Pump', brand: 'SOBO', category: 'aquarium', subCategory: 'Filter', petType: 'fish', price: '299', rating: 4.0, reviews: 5500, image: '/images/products/sobo-filter.jpg', badge: 'Amazon Choice', desc: 'Silent and highly efficient internal water filter.', benefits: ['Mechanical filtration', 'Easy to install', 'Energy efficient'], affiliateUrl: 'https://www.amazon.in/s?k=SOBO+WP-1050F+Internal+Aquarium+Filter&tag=mypawcare-21' },
  { id: 'seachem-prime', name: 'Seachem Prime Water Conditioner (100 ml)', brand: 'Seachem', category: 'aquarium', subCategory: 'Conditioner', petType: 'fish', price: '599', rating: 4.7, reviews: 4200, image: '/images/products/seachem-prime.jpg', badge: 'Premium', desc: 'Ultimate concentrated conditioner that safely removes chlorine.', benefits: ['Detoxifies ammonia', 'Promotes slime coat', 'Highly concentrated'], affiliateUrl: 'https://www.amazon.in/s?k=Seachem+Prime+Water+Conditioner+100ml&tag=mypawcare-21' },
  { id: 'hamster-food', name: 'Vitapol Economic Food for Hamster (1.2 kg)', brand: 'Vitapol', category: 'food', subCategory: 'Hamster Food', petType: 'hamster', price: '450', rating: 4.4, reviews: 2900, image: '/images/products/hamster-food.jpg', badge: 'Best Seller', desc: 'Carefully formulated blend of grains and dried veggies.', benefits: ['Complete nutrition', 'Controls tooth growth', 'Natural ingredients'], affiliateUrl: 'https://www.amazon.in/s?k=Vitapol+Economic+Food+for+Hamster&tag=mypawcare-21' },
  { id: 'hamster-wheel', name: 'Savic Hamster Exercise Wheel (Medium)', brand: 'Savic', category: 'cages', subCategory: 'Hamster Wheel', petType: 'hamster', price: '399', rating: 4.0, reviews: 850, image: '/images/products/hamster-wheel.jpg', badge: 'Trending', desc: 'Silent, smooth-spinning exercise wheel.', benefits: ['Solid running surface', 'Whisper-quiet', 'Easily attaches to cage'], affiliateUrl: 'https://www.amazon.in/s?k=Savic+Hamster+Exercise+Wheel&tag=mypawcare-21' },
  { id: 'goat-mineral', name: 'Intas Chelated Agrimin Forte Mineral Mixture (1 kg)', brand: 'Intas', category: 'feed', subCategory: 'Supplement', petType: 'goat', price: '250', rating: 4.3, reviews: 1200, image: '/images/products/goat-mineral.webp', badge: 'Best Seller', desc: 'High-quality chelated mineral mixture to improve health.', benefits: ['Enhances fertility', 'Prevents deficiency', 'Improves immunity'], affiliateUrl: 'https://www.amazon.in/s?k=Intas+Chelated+Agrimin+Forte+Mineral+Mixture&tag=mypawcare-21' },
  { id: 'horse-ointment', name: 'Himalaya Himax Ointment for Animal Wound Care (50g)', brand: 'Himalaya', category: 'grooming', subCategory: 'Health', petType: 'horse', price: '100', rating: 4.5, reviews: 4100, image: '/images/products/horse-ointment.jpg', badge: 'Best Seller', desc: 'Broad-spectrum antifungal herbal ointment.', benefits: ['Fast healing', 'Fly-repellent', 'Herbal formula'], affiliateUrl: 'https://www.amazon.in/s?k=Himalaya+Himax+Ointment+for+Animal+Wound+Care&tag=mypawcare-21' },
  { id: 'horse-brush', name: 'Equine Premium Grooming Brush & Curry Comb Set', brand: 'Equine', category: 'grooming', subCategory: 'Brush', petType: 'horse', price: '899', rating: 4.2, reviews: 300, image: '/images/products/horse-brush.jpg', badge: 'Premium', desc: 'Comprehensive horse grooming kit.', benefits: ['Removes deep mud', 'Stimulates natural oils', 'Ergonomic grip'], affiliateUrl: 'https://www.amazon.in/s?k=Equine+Premium+Grooming+Brush+Set&tag=mypawcare-21' },
  { id: 'cow-calcium', name: 'Virbac Ostovet Forte Liquid Calcium (5 Liters)', brand: 'Virbac', category: 'feed', subCategory: 'Supplement', petType: 'cow', price: '800', rating: 4.5, reviews: 2800, image: '/images/products/cow-calcium.jpg', badge: 'Best Seller', desc: 'High-performance liquid calcium to maximize milk yield.', benefits: ['Increases milk production', 'Prevents milk fever', 'Fortified with Vitamin D3'], affiliateUrl: 'https://www.amazon.in/s?k=Virbac+Ostovet+Forte+Liquid+Calcium+5+Liters&tag=mypawcare-21' },
  { id: 'cow-digestion', name: 'Ayurvet Ruchamax Digestion Powder for Cattle (1 kg)', brand: 'Ayurvet', category: 'health', subCategory: 'Digestion', petType: 'cow', price: '350', rating: 4.3, reviews: 1500, image: '/images/products/cow-digestion.jpg', badge: 'Amazon Choice', desc: 'Natural herbal digestive stimulant.', benefits: ['Treats indigestion', 'Normalizes rumen pH', 'Increases feed intake'], affiliateUrl: 'https://www.amazon.in/s?k=Ayurvet+Ruchamax+Digestion+Powder&tag=mypawcare-21' }
];
