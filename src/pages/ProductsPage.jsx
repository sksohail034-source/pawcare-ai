...
const CURATED_PRODUCTS = [
  ...
  },
  {
    ...
    rating: 4.0,
    reviews: 4120,
    image: '/images/products/petvit-multivitamin.png',
    badge: 'Top Rated',
  ...
  // ——— 3. DOG SOAP BARS ——————————————————————————————————————
  {
    ...
    rating: 4.0,
    reviews: 3420,
    image: '/images/products/medilogy-dog-soap.jpg',
    badge: 'Best Seller',
  ...
  },
  {
    ...
    rating: 4.1,
    reviews: 12340,
    image: '/images/products/basil-pet-wipes.png',
    badge: 'Amazon Choice',
  ...
  },
  {
    ...
    rating: 4.1,
    reviews: 3210,
    image: '/images/products/beaphar-ear-cleaner.png',
    badge: 'Top Rated',
  ...
  },
  {
    ...
    rating: 4.2,
    reviews: 2780,
    image: '/images/products/wahl-dog-cologne.png',
    badge: 'Premium',
  ...
  },
  {
    ...
    rating: 4.2,
    reviews: 3450,
    image: '/images/products/goofy-tails-harness.png',
    badge: 'Top Rated',
  ...
  },
  {
    ...
    rating: 4.1,
    reviews: 4230,
    image: '/images/products/petsnbuds-raincoat.png',
    badge: 'Trending',
  ...
  // ——— 3. PEE PADS ——————————————————————————————————————————
  {
    ...
    rating: 4.1,
    reviews: 11230,
    image: '/images/products/foodie-puppies-pee-pads.png',
    badge: 'Best Seller',
  ...
  // ——— 4. POOP BAGS ——————————————————————————————————————————
  {
    ...
    rating: 4.0,
    reviews: 6780,
    image: '/images/products/foodie-puppies-poop-bags.jpg',
    badge: 'Amazon Choice',
  ...
  },
  {
    ...
    rating: 4.1,
    reviews: 3450,
    image: '/images/products/trixie-travel-bowl.jpg',
    badge: 'Top Rated',
  ...
  // ——— 1. TICK & FLEA SPRAY ——————————————————————————————————
  {
    ...
    rating: 4.1,
    reviews: 7890,
    image: '/images/products/himalaya-tick-spray.jpg',
    badge: 'Best Seller',
  ...
  },
  {
    ...
    rating: 4.2,
    reviews: 4560,
    image: '/images/products/beaphar-flea-spray.png',
    badge: 'Top Rated',
  ...
  // ——— 3. JOINT SUPPLEMENTS ——————————————————————————————————
  {
    ...
    rating: 4.2,
    reviews: 6780,
    image: '/images/products/drools-joint-tabs.png',
    badge: 'Best Seller',
