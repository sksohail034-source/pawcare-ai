...
const CURATED_PRODUCTS = [
  ...
  { id: 'drools-cat-dry', name: 'Drools Adult Dry Cat Food, Ocean Fish (3kg)', brand: 'Drools', category: 'food', subCategory: 'Dry Cat Food', petType: 'cat', price: '599', rating: 4.2, reviews: 6780, image: '/images/products/drools-cat-dry.jpg', badge: 'Amazon Choice', desc: 'Affordable ocean fish flavored complete cat food. Rich in Omega-3 for healthy skin & coat.', benefits: ['Real ocean fish protein', 'Omega-3 for shiny coat', 'Great value 3kg pack'], affiliateUrl: 'https://www.amazon.in/s?k=Drools+Adult+Dry+Cat+Food+Ocean+Fish+3kg&tag=mypawcare-21' },
...
const CAT_REMAINING = [
  ...
  { id: 'cat-bowl-ceramic', name: 'Foodie Puppies Ceramic Elevated Cat Bowl (Set of 2)', brand: 'Foodie Puppies', category: 'essentials', subCategory: 'Food Bowl', petType: 'cat', price: '399', rating: 4.1, reviews: 5670, image: '/images/products/cat-bowl-ceramic.webp', badge: 'Top Rated', desc: 'Tilted ceramic bowls reduce neck strain. Whisker-friendly design.', benefits: ['Tilted — less neck strain', 'Whisker-friendly', 'Ceramic — easy clean'], affiliateUrl: 'https://www.amazon.in/s?k=ceramic+elevated+cat+bowl+set+2&tag=mypawcare-21' },
