...
export const api = {
  ...
  analyzePhoto: (petId, detectedType, image) => request(`/ai/analyze/${petId}`, { method: 'POST', body: JSON.stringify({ detectedType, image }) }),
  ...
  updateRoutine: (id, body) => request(`/routines/${id}`, { method: 'PUT', body: JSON.stringify(body) }),
